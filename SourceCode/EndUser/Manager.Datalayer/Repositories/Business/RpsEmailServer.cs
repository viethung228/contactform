...
namespace Manager.DataLayer.Repositories
{
    public class RpsEmailServer
    {
        ...
        private IdentityEmailSetting ExtractEmailSettingItem(IDataReader reader)
        {
            ...
            record.TestingSuccessed = Utils.ConvertToBoolean(reader["TestingSuccessed"]);
            record.LastInboxCount = Utils.ConvertToInt32(reader["LastInboxCount"]);
            record.LastSentCount = Utils.ConvertToInt32(reader["LastSentCount"]);
            record.LastUniqueIds = reader["LastUniqueIds"].ToString();
        ...
        {
            var sqlCmd = @"EmailServer_UpdateInboxCount";
            var metaData = string.Empty;
            ...
            var parameters = new Dictionary<string, object>
            {
                ...
                {"@AgencyId", identity.AgencyId},
                {"@StaffId", identity.StaffId},
                {"@LastInboxCount", identity.LastInboxCount},
                {"@LastUniqueIds", identity.LastUniqueIds},
            };
        ...
        {
            var sqlCmd = @"EmailServer_UpdateSentCount";
            var metaData = string.Empty;
            ...
            var parameters = new Dictionary<string, object>
            {
                ...
                {"@AgencyId", identity.AgencyId},
                {"@StaffId", identity.StaffId},
                {"@LastSentCount", identity.LastSentCount},
                {"@LastUniqueIds", identity.LastUniqueIds},
            };
