...
namespace Manager.WebApp.Models
{
    public class CommonPagingModel
    {
        ...
        {
            var index = this.Page * PageSize - PageSize + 1;
            return index;
        }
    ...
    public class DataTableQueryMeta : CommonPagingModel
    {
         
    }

    public class DataTablePagingMeta
    {
        public int page { get; set; }
    ...
    public class RequestKeyValueModel
    {
        public string Key { get; set; }
        public string Value { get; set; }
    }
