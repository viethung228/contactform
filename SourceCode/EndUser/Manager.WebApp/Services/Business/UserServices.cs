...
{
    public class UserServices : CommonServices
    {
        private static readonly ILogger _logger = Log.ForContext(typeof(UserServices));
        private static readonly string apiRoute = "api/user";

        public static async Task<ApiResponseModel> GetByPageAsync(ManageUserModel model)
        {
        ...
        public static async Task<ApiResponseModel> GetDetailAsync(UserUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
        ...
        public static async Task<ApiResponseModel> UpdateAsync(UserUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
        ...
        public static async Task<ApiResponseModel> DeleteAsync(UserUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
