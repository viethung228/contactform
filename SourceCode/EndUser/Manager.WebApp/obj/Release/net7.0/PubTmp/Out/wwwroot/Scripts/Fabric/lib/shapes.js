...
(function () {
  ...
  var shapes = function () {
    ...
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="shapes-panel"><div class="content"><p class="title">Shapes</p><div class="shapes-wrapper"></div></div></div>`);

    ShapeList.forEach(svg => {
        $(`${this.containerSelector} .toolpanel#shapes-panel .content .shapes-wrapper`).append(`<div class="button">${svg}</div>`)
    })
