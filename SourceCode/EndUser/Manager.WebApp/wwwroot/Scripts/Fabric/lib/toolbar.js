...
(function () {
    ...
    var defaultButtons = [{
        ...
        icon: `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fit="" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false"><path d="M23.906 3.969A4.097 4.097 0 0 0 21 5.188L5.187 21l-.062.313-1.094 5.5-.312 1.468 1.469-.312 5.5-1.094.312-.063L26.813 11a4.075 4.075 0 0 0 0-5.813 4.097 4.097 0 0 0-2.907-1.218zm0 1.906c.504 0 1.012.23 1.5.719.973.972.973 2.027 0 3l-.718.687-2.97-2.969.688-.718c.489-.489.996-.719 1.5-.719zm-3.593 2.844l2.968 2.969L11.188 23.78a6.813 6.813 0 0 0-2.97-2.968zM6.938 22.438a4.734 4.734 0 0 1 2.625 2.625l-3.282.656z"></path></svg>`
    }, {
        name: 'line',
        title: 'Line',
        ...
        icon: `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fit="" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false"> <path d="M15 6L8 26h2l2.098-6h4.992A7.918 7.918 0 0 0 16 24c0 4.398 3.602 8 8 8s8-3.602 8-8-3.602-8-8-8c-1.16 0-2.258.254-3.254.703L17 6zm1 2.86l3.094 8.84a8.616 8.616 0 0 0-.36.3h-5.933zM24 18c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6zm-1 2v3h-3v2h3v3h2v-3h3v-2h-3v-3z"></path> </svg>`
    }, {
        name: 'upload',
        title: '画像',
        ...
        name: 'cropping',
        title: '切り抜き',
        icon: `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fit="" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false"><path d="M8 4v4H4v2h4v14h14v4h2v-4h4v-2H11.437L22 11.437V21h2V9.437l3.719-3.718L26.28 4.28 22.563 8H11v2h9.563L10 20.563V4z"></path></svg>`
    }]
        ...
        try {
            ...
            (() => {
                buttons.forEach(item => {
                    $(`${this.containerSelector} #toolbar .main-buttons`).append(`<button type="button" id="${item.name}"><div class="toolbar-button-content"><div class="toolbar-button-icon">${item.icon}</div><div class="toolbar-button-title">${item.title}</div></div></button>`);
                })
            ...
            (() => {
                ...
                $(`${this.containerSelector}`).prepend(
