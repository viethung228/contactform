...
{
    public class IdentityCustomer : IdentityCommon
    {
        ...
        public List<IdentityCustomerClaim> Claims { get; set; }
        ...
        public IdentityCustomer()
        {
            this.Claims = new List<IdentityCustomerClaim>();
            this.Roles = new List<string>();
            this.Id = Guid.NewGuid().ToString();
            LockoutEnabled = true;
        }

        public IdentityCustomer(string userName)
            : this()
        {
    ...
    public sealed class IdentityCustomerLogin
    {
        public string Id { get; set; }
    ...
    public class IdentityCustomerClaim
    {
        public string ClaimType { get; set; }
        public string ClaimValue { get; set; }
    }

    public class IdentityStatisticsUCustomerByYear
    {
