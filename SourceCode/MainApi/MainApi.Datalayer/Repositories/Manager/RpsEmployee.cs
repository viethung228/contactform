...
namespace Manager.Datalayer.Repositories
{
    public class RpsEmployee
    {
        ...
        {
            //Common syntax           
            var sqlCmd = @"Employee_ConfirmEmail";
            //For parameters
            var parameters = new Dictionary<string, object>
            {
                {"@Id", id}
        ...
        {
            IdentityEmployee info = null;
            var sqlCmd = @"Employee_GetByEmail";
        ...
        {
            //Common syntax           
            var sqlCmd = @"Employee_GetListByPermission";
            List<IdentityEmployee> listData = new List<IdentityEmployee>();
        ...
        {
            //Common syntax            
            var sqlCmd = @"Employee_GetListReceiveAllUpdate";
