...
namespace MainApi.Controllers
{
    ...
    {
        private static readonly ILogger _logger = Log.ForContext(typeof(AuthorizeBaseController));
        ...
        public int GetCurrentUserId()
        {
            ...
            try
            {
                ...
                if(jwtToken != null)
                {
                    staffId = int.Parse(jwtToken.Claims.First(x => x.Type == "Id").Value);
                }                
            }
        ...
        public int GetCurrentAgentId()
        {
            ...
            try
            {
                ...
                if (jwtToken != null)
                {
                    agentId = int.Parse(jwtToken.Claims.First(x => x.Type == "Id").Value);
                }
            }
            catch (TokenExpiredException)
            {
        ...
        public int GetCurrentParentId()
        {
            ...
            try
            {
                ...
                if (jwtToken != null)
                {
                    agentId = int.Parse(jwtToken.Claims.First(x => x.Type == "ParentId").Value);
                }
            }
            catch (TokenExpiredException)
            {
