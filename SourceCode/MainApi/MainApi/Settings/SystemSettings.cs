...
namespace MainApi.Settings
{
    ...
    public class SystemSettings
    {
        ...
        public static string BaseUrl
        {
            get
            {
                return AppConfiguration.GetAppsetting("SystemSetting:BaseUrl");
            }
        }
        ...
        public static string JwtSecretKey
        {
            get
            {
                return AppConfiguration.GetAppsetting("Jwt:Key");
            }
        }

        public static string UserDefaultPassword
        {
            get
            {
                return AppConfiguration.GetAppsetting("SystemSetting:UserDefaultPassword");
            }
        }
