...
// Image editor
var imageEditor = new tui.ImageEditor('.jz-graphic', {
    cssMaxWidth: 700,
    cssMaxHeight: 500,
    selectionStyle: {
        cornerSize: 20,
...
function resizeEditor() {
    var $editor = $('.jz-graphic');
    var $container = $('.jz-graphic-canvas-container');
