...
{
    public class CompanyServices : CommonServices
    {
        private static readonly ILogger _logger = Log.ForContext(typeof(CompanyServices));
        private static readonly string apiRoute = "api/company";

        public static async Task<ApiResponseModel> GetByPageAsync(ManageCompanyModel model)
        {
        ...
        public static async Task<ApiResponseModel> GetDetailAsync(CompanyUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
        ...
        public static async Task<ApiResponseModel> GetDetailByNameAsync(string companyName)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
                ...
                IRestRequest restRequest = new RestRequest(string.Format("{0}/getbyname?companyFullName={1}", apiRoute, companyName), Method.GET);
        ...
        public static async Task<ApiResponseModel> GetDetailByEmailAsync(string email)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
                ...
                IRestRequest restRequest = new RestRequest(string.Format("{0}/getbyemail?email={1}", apiRoute, email), Method.GET);
        ...
        public static async Task<ApiResponseModel> UpdateAsync(CompanyUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
        ...
        public static async Task<ApiResponseModel> DeleteAsync(CompanyUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
