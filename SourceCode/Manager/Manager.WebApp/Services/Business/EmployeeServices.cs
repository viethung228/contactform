...
{
    public class EmployeeServices : CommonServices
    {
        private static readonly ILogger _logger = Log.ForContext(typeof(EmployeeServices));
        private static readonly string apiRoute = "api/employee";

        public static async Task<ApiResponseModel> GetByPageAsync(ManageEmployeeModel model)
        {
        ...
        public static async Task<ApiResponseModel> GetDetailAsync(EmployeeUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
        ...
        public static async Task<ApiResponseModel> UpdateAsync(EmployeeUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
        ...
        public static async Task<ApiResponseModel> DeleteAsync(EmployeeUpdateModel model)
        {
            ApiResponseModel returnModel = new ApiResponseModel();
            try
            {
