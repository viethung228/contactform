...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jz-code-snippet"));
	else if(typeof define === 'function' && define.amd)
		define(["jz-code-snippet"], factory);
	else if(typeof exports === 'object')
		exports["colorPicker"] = factory(require("jz-code-snippet"));
	else
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function View(options, container) {
	    ...
	    domutil.addClass(container, 'jz-view-' + id);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 *  @param {string} [options.cssPrefix='jz-colorpicker-'] - css prefix text for each child elements
	 *  @param {string} [options.detailTxt='Detail'] - text for detail button.
	 *  @param {boolean} [options.usageStatistics=true] - Let us know the hostname. If you don't want to send the hostname, please set to false.
	 * @example
	 * var colorPicker = tui.colorPicker; // or require('jz-color-picker')
	 * 
