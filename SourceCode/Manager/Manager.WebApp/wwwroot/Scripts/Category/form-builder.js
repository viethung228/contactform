...
! function (e) {
    ...
    ! function (e) {
        ...
        n.a.register(["text"], h), n.a.register(["text", "password", "email", "color", "tel"], h, "text");
        class g extends h {
            static get definition() {
                return {
                    i18n: {
        ...
        function I(e, t, r) {
            ...
            const _ = t => {
                const {
                    ...
                    const t = [ "label","className", "name", "value"],
                        ...
                        o = {
                            ...
                            select: ["className","label", "options"],
                        };
            ...
            function oe(e, t) {
                ...
                return `<div class="form-group ${e}-wrap">${a}${`<div class="input-wrap">${(() => {
                    if ("textarea" === l.type) { const e = l.value; return delete l.value, `<textarea ${Object(p.b)(l)}>${e}</textarea>` } return `<input ${Object(p.b)(l)}>`
                })()
                    } < /div>`}</div > `
            } function ne(e, t) {
                const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t, u = x(t, ["multiple", "options", "label", "value", "class", "className"]), f = Object.keys(o).map(e => { const t = { value: e }, r = o[e], n = Array.isArray(r) ? c.a.get(...r) || r[0] : r; return (Array.isArray(l) ? l.includes(e) : e === l) && (t.selected = null), C("option", n, t) }), p = {
                    id: `
            $ {
                e
            } - $ {
